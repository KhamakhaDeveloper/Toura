...
/**
 ...
 If lastFramePersist (Inherited from ARPlayableTexture) is set to YES, this will become the frame that gets continually rendered when the sequence has finished.
 */
