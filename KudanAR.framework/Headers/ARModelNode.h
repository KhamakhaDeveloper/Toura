...
/**
 A delegate for animation related events.
 Add this as a delegate receive messages each frame the animation renders and when the animation finishes.
 */
...
/**
 A array of all the meshes that construct and are rendered by the model node.
 */
...
/**
 ...
 Example of use:
 @code
 ARMeshNode *meshNode = [self.modelNode findMeshNode:"Example Mesh"];
 @endcode
 
 @param name Name of the mesh node to search for.
 
 @return An ARMeshNode with the given name.
 */
