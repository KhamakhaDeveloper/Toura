...
/**
 An ARMesh is a class representing the geometry and mapping of a mesh. 
 It is a collection of vertices, edges and faces that define the shape of an object. 
 It also specifies the data of this mesh, including the vertex data, bones and texture data.
 */
