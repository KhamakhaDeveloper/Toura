...
/**
 The ARImageTrackable class represents an image that can be tracked. 
 Add ARImageTrackables to the ARImageTrackerManager in order to display content on those trackables.
 The ARImageTrackerManager will automatically update properties of any trackables added to it.
 Add ARNodes as children of the ARImageTrackable's world to render content on the trackable.
 */
...
/**
 Initialises an ARImageTrackable using a .KARMarker data set.
 A .KARMarker is a custom format that is more lightweight than that of a usual .jpg file.
 This means that, by converting marker images into .KARMarker files, a good deal of space can be saved.
...
/**
 ...
 @param bundledFile The file path to the trackable file relative to the main project bundle, including the file extension. This file should have been generated by the Kudan AR Toolkit and be in the .KARMarker format.
