...
/**
 ...
 @return The ImageTracker singleton.
 */
 ...
 * An empty array of trackables is created.
 ...
 * The array of trackables is emptied.
 * The array of detected trackables is emptied, meaning any markers currently being detected will be lost, and any nodes that are currently visible will stop being rendered.
...
/** 
 ...
 @param maxToTrack The maximum number of trackables which can be tracked simultaneously.
 */
...
/**
 ...
 Example of use:
 @code
 BOOL recoveryStatus = [[ARImageTrackerManager getInstance] queryRecoveryMode];
 @endcode
