...
/**
 An ARTextureMaterial is a material for shading a texture. 
 This is commonly used with 3D models that do not require dynamic lighting.
 This type of material is functionally the same as setting the colour property of an ARLightMaterial with a texture.
 */
