...
/**
 ...
 This applies to all markers in the set. To alter a specific marker within the set, it is necessary to take the trackable from the array and set it individually.
